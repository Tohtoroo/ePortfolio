...
const SEP = () => {
  ...
  />
        ...
        <em>
          Figure S1. Screenshot of Shona's original compiled thoughts on the difference in rigour observed when taking English Literature courses in both University of North Carolina at Chapel Hill (UNC) and National University of Singapore (NUS). Written annotations coloured in blue and orange were made for the purpose of initial discussion during the podcast. This composite artifact comprised of three separate screenshots from Shona's class notes, which were typed out at the time of attending the class. On the left hand side: screenshot from ENGL 219 first class notes (top) and screenshot of notes taken during April classes (bottom). On the right side hand: screenshot from EN2201 first class notes.
          </em>
      </div>
  ...
  />
        ...
        <em>
        Figure V1. Screenshot of Viola's compilation of pros and cons comparing academic rigour in NUS and Rikkyo University. The screenshot compares the course contents page between EAL3811: English Seminar 13 and EN4222: The Eighteenth Century, with annotations on the side analyzing the professor's motivations on deciding the topic and texts, dated 18th September 2024.
        </em>
      </div>
  ...
  />
        ...
        <em>
        Figure A1. Notes Aeron wrote for a UNC course MATH524: Elementary Differential Equations that he took in Year 3 Semester 1 where he annotated on the side of two equations “what is the conceptual understanding of this”. The parts in brown are Aeron's current day annotations.
        </em>
      </div>
...
<div style={styleImage} onClick={() => openModal("/assets/USR/SEP_FigA6_9.PNG")}>
  ...
  />
        ...
        <em>
        Figure V2. Screenshot of an excerpt from Viola's EN2022 exam script, where she showed how she derived a close reading of a poem, dated 14th April 2022.
        </em>
      </div>
...
<div style={styleImage} onClick={() => openModal("/assets/USR/SEP_FigV3_11.jpg")}>
  ...
  />
        ...
        <em>
        Figure V3. Screenshot showing an excerpt from a 7 page document the professor from Viola's EN2022: Critical Reading course provided, detailing writing tips for class assignments, dated 12th March 2022.
        </em>
      </div>
  ...
  />
        ...
        <em>
        Figure A7. A screengrab of notes that were used to teach in the NUS course MA4255: Numerical Methods in Differential Equations taken by Aeron. Although the course itself was very rigorous in their way or proof-making, it was not particularly clear or helpful with the explanations to reach said rigour in their proof of the theorems. Without some less rigorous way of teaching to help assist in the understanding of the heavy mathematical notations used, it gets quite easily lost during the teachings that it may instead hinder the learning experience instead.
        </em>
      </div>
