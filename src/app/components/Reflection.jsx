    ...
    },
    {
      ...
      content: (
        <>
          ...
          <p className="mt-6">For me, rigour in Mathematics has always meant starting with a solid foundation of axioms/theorems and carefully building up through logical steps to reach a new conclusion. However, during my exchange at the <a href="https://www.unc.edu/" target='_blank' rel="noopener noreferrer" class='more-link'>University of North Carolina, Chapel Hill (UNC-CH)</a>, I found that the approach to some of the Mathematics courses there very different. Instead of focusing on proofs and deeper conceptual understanding, the emphasis was placed on applying fomulas to solve problems, an experience which I found to be <i>dissatisfactory</i>. My experience along with the experiences of my fellow friends, made me realise how much I value NUS's approach to rigour in my Mathematics education, where I am rigorously taught proofs and to truly understand them.</p>
