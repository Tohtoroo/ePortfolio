...
const Heartbreak = () => {
  ...
  return (
    <div className="p-6 max-w-4xl mx-auto text-gray-700 flex flex-col pt-40">
      ...
      <p className="mt-6">
        According to the <a href="https://www.oed.com/dictionary/rationality_n?tl=true" target='_blank' rel="noopener noreferrer" class='more-link'>Oxford English Dictonary</a>, rationality is
      </p>
      {/* Quote Section */}
      <blockquote className="mt-6 border-l-4 border-gray-400 pl-4">
        “The fact or condition of being based on, or in accordance with, <b>reason</b> or <b>rationalism</b>.”
      </blockquote>

      <p className="mt-6">
        Mathematics epitomises this definition; every conclusion follows from established axioms and every theorem is built on a chain of logical reasoning, a truth built upon a foundation of accepted truths. I have been taught this line of logical reasoning from the very first course I had to take as part of my core curriculum &#8211; <a href="https://nusmods.com/courses/MA1100/basic-discrete-mathematics" target='_blank' rel="noopener noreferrer" class='more-link'>MA1100: Basic Discrete Mathematics</a>.
      </p>
      ...
      <div className="text-center mt-6">
        ...
        <em>Figure 3. My own assignment answers from <a href="https://nusmods.com/courses/MA2104/multivariable-calculus" target='_blank' rel="noopener noreferrer" class='more-link'>MA2104: Multivariable Calculus</a>, <a href="https://nusmods.com/courses/MA2101/linear-algebra-ii" target='_blank' rel="noopener noreferrer" class='more-link'>MA2101: Linear Algebra II</a>, <a href="https://nusmods.com/courses/MA2202/algebra-i" target='_blank' rel="noopener noreferrer" class='more-link'>MA2202: Algebra I</a> and <a href="https://nusmods.com/courses/MA3211/complex-analysis-i" target='_blank' rel="noopener noreferrer" class='more-link'>MA3211: Complex Analysis I</a> respectively. Marked in red are the signs of logical deductions used in my answer.</em>
      </div>
