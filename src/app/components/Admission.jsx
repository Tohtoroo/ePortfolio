  ...
  return (
    <div className="p-6 max-w-4xl mx-auto text-gray-700 flex flex-col pt-40">
      ...
      <div className="text-center mt-6">
        ...
        <em>Figure 2. The golden ratio in its algebraic and decimal form and the golden spiral which is defined using the golden ratio. The pictures were taken from <a
          href="https://en.wikipedia.org/wiki/Golden_ratio"
          target="_blank"
          rel="noopener noreferrer"
          class='more-link'
        > Wikipedia</a>, and <a
          href="https://sketchplanations.com/the-golden-ratio"
          target="_blank"
          rel="noopener noreferrer"
          class='more-link'
        >Sketchplanations</a> respectively.</em>
      </div>
      ...
      <div className="text-center mt-6">
        ...
        <em>Figure 3. The final slide Professor Don showed us for the course <a href="https://nusmods.com/courses/NST2005/the-doors-of-perception-biology-technology-culture" target='_blank' rel="noopener noreferrer" class='more-link'>NST2005: Doors of Perception</a>, a course that I took in year 3 semester 2.</em>
      </div>
